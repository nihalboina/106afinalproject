...
from utils.utils import get_g_matrix
...
class LinearTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            pos = self.start_position + self.distance/2.0 + self.v_max * t - 0.5 * self.acceleration * t**2
    ...
    def target_velocity(self, time):
        ...
        linear_vel = np.append(linear_vel, 0)
        
        # linear_vel = np.matmul(g_inv, linear_vel)[:3]
